...
require('lazy').setup({
  ...
  --
  -- Native Neovim 0.10+ commenting (gc/gcc) is used instead of Comment.nvim.
  -- It reads vim.bo.commentstring automatically; see ftplugin/ for per-filetype overrides.
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ds', ":lua require('telescope.builtin').lsp_document_symbols { symbol_width = 100 }<CR>", '[D]ocument [S]ymbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map(
            '<leader>ws',
            ":lua require('telescope.builtin').lsp_dynamic_workspace_symbols { fname_width = 30, symbol_width = 70 }<CR>",
            '[D]ocument [S]ymbols'
          )
...
require 'custom.mappings.general'
